...
public class HammerItem extends DiggerItem implements Vanishable {
    ...
    // We get the list of all block positions that we want to destroy here
    // player.level().clip() -> the idea of clip is draw a line from the player more or less, and
    // you're going to see the rist block that it collides with

...
public class ModToolTiers {
    // TierSortingRegistry -> our tier should be better than (in this case) netherite.
    // When you put a tier, then that means that the tier you are creating is going to be above of it
